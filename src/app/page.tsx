  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-linear-to-b from-background to-muted/30">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <div className="hidden lg:flex items-center justify-center">
                <div className="relative w-full aspect-square md:aspect-4/3 overflow-hidden rounded-lg bg-card p-6 shadow-lg">
                  <div className="absolute inset-0 bg-linear-to-br from-primary/10 via-transparent to-background border-2 border-border rounded-lg"></div>
